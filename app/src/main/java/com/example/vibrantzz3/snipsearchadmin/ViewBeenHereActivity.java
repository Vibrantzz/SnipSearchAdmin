...
public class ViewBeenHereActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    List<BeenHere> visitedData;
    String id;
    BeenHereRecyclerViewAdapter myAdapter;
    RecyclerView myrv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beenhere);
        Toolbar mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle("Been Here");
        ...
        /*uname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ViewBeenHereActivity.this , User.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_appointment) {
            ...
            Intent intent = new Intent(ViewBeenHereActivity.this , Settings.class);
            startActivity(intent);
                ...
                public void run() {
                    try {
                        ...
                        for(int i=0;i<jArray.length();i++){
                            ...
                            visitedData.add(new BeenHere( json_data.getString(TAG_NAME), json_data.getString(TAG_CITY), json_data.getString(TAG_RATE), json_data.getString(TAG_PIC),json_data.getString(TAG_ID),id," Based on "+ json_data.getString(TAG_RCOUNT) +" Reviews"));
                        }


                        myrv=(RecyclerView) findViewById(R.id.bookmark_recycler);
                        myAdapter=new BeenHereRecyclerViewAdapter(ViewBeenHereActivity.this,visitedData);
                        myrv.setLayoutManager(new LinearLayoutManager(ViewBeenHereActivity.this));
