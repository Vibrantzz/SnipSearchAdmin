...
public class MenuFragment extends Fragment {
    ...
    List<Menu> MenuData;
    String id;
    MenuRecyclerViewAdapter myAdapter;
    RecyclerView myrv;
        ...
        protected void onPostExecute(final String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++){
                    ...
                    MenuData.add(new Menu( json_data.getString(TAG_ID),json_data.getString(TAG_PHOTO)));
                }


                myrv=(RecyclerView) view.findViewById(R.id.menu_recycler);
                myAdapter=new MenuRecyclerViewAdapter(getContext(),MenuData);
