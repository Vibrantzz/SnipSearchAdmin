...
public class InactiveOffersFragment extends Fragment {
    View view;
    List<Offers> aData;
    OffersRecyclerViewAdapter myAdapter;
    RecyclerView myrv;
    private static final String url_appt = "http://test.epoqueapparels.com/CRUD/showAllOffers1.php";
